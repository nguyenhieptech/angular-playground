...
export class HlmDatePickerMulti<T> implements ControlValueAccessor {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      "inline-flex h-9 w-[280px] cursor-default items-center justify-between gap-2 rounded-md border border-input bg-background px-3 py-2 text-left text-sm font-normal whitespace-nowrap ring-offset-background transition-all hover:bg-accent hover:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 dark:bg-input/30 dark:hover:bg-input/50",
