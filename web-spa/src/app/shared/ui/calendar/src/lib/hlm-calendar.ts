...
@Component({
  selector: "[hlmCalendar],hlm-calendar",
  imports: [
    BrnCalendarImports,
    NgIcon,
    HlmIcon,
          ...
          <div class="relative flex items-center justify-center pt-1">
            ...
            <div class="flex items-center space-x-1">
              ...
              <button
                ...
                class="absolute right-1 inline-flex size-8 items-center justify-center rounded-md bg-transparent p-0 text-sm font-medium whitespace-nowrap text-popover-foreground transition-colors hover:bg-accent hover:text-accent-foreground hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
              >
          ...
          <tbody role="rowgroup">
            <tr *brnCalendarWeek="let week" class="mt-2 flex w-full">
              @for (date of week; track _dateAdapter.getTime(date)) {
                <td
                  brnCalendarCell
                  class="relative size-8 p-0 text-center text-sm focus-within:relative focus-within:z-20 data-[selected]:bg-accent first:data-[selected]:rounded-l-md last:data-[selected]:rounded-r-md data-[selected]:data-[outside]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-md"
                >
...
export class HlmCalendar<T> {
  ...
  protected readonly _btnClass = hlm(
    ...
    "data-[selected]:bg-primary data-[selected]:text-primary-foreground data-[selected]:hover:bg-primary data-[selected]:focus:bg-primary data-[selected]:focus:text-primary-foreground dark:hover:text-accent-foreground",
